        ...
        },
        {
            ...
            fn: () => makeTaskReport([
                ...
                () => {
                    ...
                    return element && ["summer", "todo", "list"].every((word) => element.textContent?.trim().toLowerCase().includes(word));
                }
            ]),
        },
        {
        ...
        },
        {
            ...
            "fn": () => makeTaskReport([
                ...
                () => {
                    ...
                    return element && ["add", "item"].every((word) => element.textContent?.trim().toLowerCase().includes(word));
                }
            ])
        },
        {
            ...
            "fn": () => makeTaskReport([
                ...
                () => {
                    ...
                    return element && ["clear", "list"].every((word) => element.textContent?.trim().toLowerCase().includes(word));
                }
            ]),
        },
        {
