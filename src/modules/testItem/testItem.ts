...
import { Test, TestItemConfig, TestResultReport, TestStatus } from "../../types/declaration";
import { miniMarkdown, getTestStatusIcon } from "../../utils";
import ExamTracker from "../examTracker/examTracker";
...
export default class TestItem extends HTMLElement {
    ...
    #status: TestStatus;
    #suite: ExamTracker;
    #partialResults: TestResultReport | undefined;

    constructor({ id, name, about, status, fn, suite, }: TestItemConfig) {
        super();
        this.#id = id;
        this.#name = name;
        this.#about = about;
    ...
    set partialResults(results: TestResultReport) {
    ...
    set status(newStatus: TestStatus) {
    ...
    set icon(newIcon: SVGSVGElement) {
