import { TestResultReport } from "../types/declaration";
 ...
 */
export const makeTaskReport = async (taskList: Array<string | Function>): Promise<TestResultReport> => {

    const state: TestResultReport = { completed: 0, total: 0 };
